package com.sarsila.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.sarsila.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.sarsila.springboot.model" });
